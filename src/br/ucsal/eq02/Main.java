...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Atom atomBracket = new Atom("B03", "(", "\\(", AtomType.SYMBOL);
        atoms.add(atomBracket);

        atoms.add(new Atom("B04", "/", AtomType.SYMBOL));

        Atom atomSemiColon = new Atom("B05", ";", AtomType.SYMBOL);
        atoms.add(atomSemiColon);
        ...
        Atom atomEqual = new Atom("B10", "=", AtomType.SYMBOL);
        atoms.add(atomEqual);
        ...
        List<Atom> afterAtomsFunction = new ArrayList<>();
        afterAtomsFunction.add(atomBracket);
        atoms.add(new Atom("C04", "Function", "[a-z0-9_]+[a-z0-9]|[a-z]",
                AtomType.IDENTIFIER, afterAtomsFunction));

        List<Atom> afterAtomsIdentifier = new ArrayList<>();
        afterAtomsIdentifier.add(atomEqual);
        afterAtomsIdentifier.add(atomSemiColon);
        atoms.add(new Atom("C05", "Identifier", "[a-z0-9_]*[a-z_]+",
